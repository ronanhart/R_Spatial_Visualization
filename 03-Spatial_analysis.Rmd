...
```{r loadRast , echo = F}
elev_snow_stk <- rast("Data/Exercises/elev_snow_nw_stack.tif")
...
```{r loadRCLquiet, echo = F}
landcover_rcl <- rast("Data/Examples/landcover_rcl.tif")
```
```{r rclLand, eval = F}
